...
INSERT INTO newfilm_1900_1910
select venue_type, programme_date, country, title
FROM tblfilm, tblvenue
...
WHERE tblprogramme.programme_date >= '1900-01-01 00:00:00'::timestamp without time zone AND tblprogramme.programme_date <= '1910-01-01 00:00:00'::timestamp without time zone AND venue_type = 'Cinema' AND tblfilm.country = 'NLD'
limit 1000;
...
select venue_type, programme_date, country, title
  FROM tblfilm, tblvenue
     JOIN tblprogrammeitem ON tblprogrammeitem.film_id::text = tblfilm.film_id::text
     JOIN "tblprogramme" ON "tblprogramme".programme_id::text = "tblprogrammeitem".programme_id::text
  WHERE "tblprogramme".programme_date >= '1900-01-01 00:00:00'::timestamp without time zone AND "tblprogramme".programme_date <= '1910-01-01 00:00:00'::timestamp without time zone;
...
JOIN tblprogrammeitem ON tblprogrammeitem.film_id::text = tblfilm.film_id::text
JOIN tblprogramme ON tblprogramme.programme_id::text = tblprogrammeitem.programme_id::text
WHERE tblprogramme.programme_date >= '1900-01-01 00:00:00' AND tblprogramme.programme_date <= '1910-01-01 00:00:00' AND tblfilm.country = 'NLD'
